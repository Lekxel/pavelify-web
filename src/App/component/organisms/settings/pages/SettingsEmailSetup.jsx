...
const SettingsEmailSetup = () => (
  <div className="right-side Operating-right-side">
    ...
    <div className="step">
      ...
      <p>
        If you don’t find your email provider below, simple search for the instructions on Google by
        typing your email provider name alongside “email forwarding setup instructions” or contact
        your email provider.
      </p>
    </div>
    ...
    <div className="email_provider_pure">
      <img src={pic9} alt="" />
      <a href="https://uk.godaddy.com/help/set-up-my-forwarding-email-address-7598" target="_blank">
